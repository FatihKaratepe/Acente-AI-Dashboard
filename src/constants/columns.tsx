...
import { Car, CheckCircle2, Clock, CreditCard, HeartPulse, Home, Plane } from 'lucide-react';
...
export const getColumns = ({
        ...
        case 'Auto':
          return (
            <div className="flex items-center gap-2">
              <Car className="h-4 w-4 text-blue-500" /> Auto
            </div>
          );
        case 'Health':
          return (
  ...
  columnHelper.display({
    ...
    size: 50,
    cell: ({ row }) => (
      <PolicyActions policy={row.original} onEdit={onEdit} onDelete={onDelete} onInquire={onInquire} />
    ),
  }),
];
